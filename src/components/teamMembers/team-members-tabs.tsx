...
export function TeamMembersTabs({ onTeamMemberClick, refreshTrigger }: TeamMembersTabsProps) {
  ...
  const getFilteredTeamMembers = () => {
    switch (activeTab) {
      case "hiring-manager":
        return teamMembers.filter(member => member.department === "Hiring Manager");
      case "team-lead":
        return teamMembers.filter(member => member.department === "Team Lead");
      case "recruiters":
        return teamMembers.filter(member => member.department === "Recruiters");
      case "head-enter":
        return teamMembers.filter(member => member.department === "Head Enter");
      default:
        return teamMembers;
    }
  };
        ...
        <TabsList className="flex border-b w-full rounded-none justify-start h-12 bg-transparent p-0">
          ...
          >
            ...
            <Badge variant="secondary" className="ml-1 text-xs">
              {getCountByDepartment("Hiring Manager")}
            </Badge>
          </TabsTrigger>
          <TabsTrigger
            value="team-lead"
          ...
          >
            ...
            Team Lead
            <Badge variant="secondary" className="ml-1 text-xs">
              {getCountByDepartment("Team Lead")}
            </Badge>
          </TabsTrigger>
          <TabsTrigger
            value="recruiters"
          ...
          >
            ...
            Recruiters
            <Badge variant="secondary" className="ml-1 text-xs">
              {getCountByDepartment("Recruiters")}
            </Badge>
          </TabsTrigger>
          <TabsTrigger
            value="head-enter"
          ...
          >
            ...
            Head Enter
            <Badge variant="secondary" className="ml-1 text-xs">
              {getCountByDepartment("Head Enter")}
            </Badge>
          </TabsTrigger>
        </TabsList>
