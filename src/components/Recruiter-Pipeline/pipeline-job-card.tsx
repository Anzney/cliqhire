...
import { ChevronDown, ChevronRight, Users, MapPin, DollarSign, Briefcase, Building2, Tag, Pin, Loader2 } from "lucide-react";
...
function CandidateCard({ candidate, jobId, onUpdateStage }: CandidateCardProps) {
  return (
